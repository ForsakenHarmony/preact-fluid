...
const StyledRadio = styled.span`
	...
	.radio {
		...
		&.circle:checked + label {
			...
			box-shadow: inset rgba(0, 0, 0, 0.117647) 0 0 1px 0,
				inset rgba(0, 0, 0, 0.239216) 0 1px 2px 0;
			transition: all 0.2s;
			${props =>
	...
	label {
		...
		&:before {
			...
			box-shadow: rgba(0, 0, 0, 0.117647) 0 0 2px 0,
				rgba(0, 0, 0, 0.239216) 0 2px 2px 0;
			transition: all 0.2s;
			${props =>
				props.highlightColor &&
				css`
		...
		&:hover:before {
			box-shadow: rgba(0, 0, 0, 0.0784314) 0 0 3px 0,
				rgba(0, 0, 0, 0.239216) 0 3px 3px 0;
		}
...
export { StyledRadio, StyledLabel };
